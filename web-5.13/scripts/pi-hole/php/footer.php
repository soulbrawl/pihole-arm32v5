...
<?php
    ...
    $coreVersionStr = "5.11.4";
    $ftlVersionStr = "5.16.1";
    $webVersionStr = "5.13";
    ...
    $coreReleasesUrl = $coreUrl . "/releases/tag";
    $dockerReleasesUrl = $dockerUrl . "/releases";
    $ftlReleasesUrl = $ftlUrl . "/releases/tag";
    $webReleasesUrl = $webUrl . "/releases/tag";
?>
            ...
            <div class="col-xs-12 col-sm-8 col-md-6">
                ...
                <ul class="list-inline">
                    ...
                    <li>
                        ...
                        <a href="<?php echo $coreReleasesUrl . "/" . $coreVersionStr; ?>" rel="noopener" target="_blank"><?php echo $coreVersionStr; ?></a>
                    ...
                    <li>
                        <strong>FTL</strong>
                        <a href="<?php echo $ftlReleasesUrl . "/" . $ftlVersionStr; ?>" rel="noopener" target="_blank"><?php echo $ftlVersionStr; ?></a>
                    ...
                    <li>
                        ...
                        <a href="<?php echo $webReleasesUrl . "/" . $webVersionStr; ?>" rel="noopener" target="_blank"><?php echo $webVersionStr; ?></a>
